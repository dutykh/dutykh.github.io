...
Here is a simulation of a kink passing through a T-junction:
...
More details can be found in our first common preprint:
...
Moreover, I just released in Open source the script [FreeFem++](http://www.freefem.org/ff++/) that we used to perform the simulations shown above:
