...
These numerical results were obtained by solving the classical Nonlinear Shallow Water Equations (NSWE) on an unstructured triangular grid using the finite volume method, along with a time-adaptive scheme, of course.
